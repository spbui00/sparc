...
selected_plot_channel = 5;
figure();
plot(squeeze(synthetic_GT(:,selected_plot_channel)));
hold on;
plot(squeeze(data(1,:,selected_plot_channel)));
hold on;
plot(squeeze(dataCleaned(1,:, selected_plot_channel)));
hold off;
...
[mse, psd_mse_values] = SynGT_performance_metrics(synthetic_GT, squeeze(dataCleaned(1,:,1:5)));